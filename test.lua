...
do
    ...
    do
        function Menu.CreateWindow(Parameters)
            ...
            local Name = Parameters.Name or "airwave.lua"
            ...
            do
                ...
                function Window.Notify(Parameters)
                    ...
                    local Text = Parameters.Text or "67 ohio boy sigma sus"
